<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
  ...
  <script type="text/javascript" src="/issuewhatshow/resources/third-party-etc/popper.min.js"></script>
  <script type="text/javascript" src="/issuewhatshow/resources/bootstrap/4.3.1/dist/js/bootstrap.min.js"></script>
